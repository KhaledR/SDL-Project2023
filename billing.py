...
class Billing:
    ...
    #========Customer_Frame==========#
        ...
        print_Button = Button(bill_menu_Frame, text="Print", font=("times new roman", 13, "bold"),
                                bg="#00FF7F")
        print_Button.place(x=2, y=86, width = 120, height = 50)
        clear_Button = Button(bill_menu_Frame, text="Clear All", font=("times new roman", 13, "bold"),
                              bg="#ECFFDC")
        clear_Button.place(x=124, y=86, width = 120, height = 50)

        generate_Button = Button(bill_menu_Frame, text="Generate Bill", font=("times new roman", 13, "bold"),
                              bg="#40826D")
        generate_Button.place(x=246, y=86, width = 120, height = 50)
    ...
    def bill_updates(self):
        bill_amount = 0
        for row in self.cart_List:
            bill_amount = bill_amount + (float(row[3])*int(row[4]))
